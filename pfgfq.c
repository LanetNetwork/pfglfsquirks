...
void glfs_walk_dir_generic(glfs_t* _fs, const char* _entry_point, glfs_dentry_handler_t _handler, glfs_dentry_comparator_t _comparator, void* _data, unsigned int _level)
{
	glfs_fd_t* fd = NULL;
